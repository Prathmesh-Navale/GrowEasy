...
export default function DataTable({ columns, rows, maxHeight = 360 }: Props) {
  return (
    <div className="ge-table">
      ...
      <style jsx>{`
        .wrap{max-height:${maxHeight}px;overflow:auto;border:1px solid var(--border);border-radius:8px;background:var(--surface);box-shadow:inset 0 1px 0 rgba(255,255,255,.16)}
